        ...
        <div className="bg-slate-800 shadow-2xl rounded-md mx-20 py-4">
            ...
            <form className='' onSubmit={e=>e.preventDefault()}>
                <div className=''>
                    ...
                    <input className='input md:w-1/2 :border-slate-900 bg-[#0e1e2c]' value={name} onChange={(e)=>setName(e.target.value)} type="text" placeholder='Name' />
                </div>
                <div className=''>
                    <label className='label text-white' htmlFor="name">Email</label>
                    <input className='input md:w-1/2 bg-[#0e1e2c]' placeholder='Email' value={email} onChange={(e)=>setEmail(e.target.value)} type="text" />
                </div>
                <div className=''>
                    <label className='label text-white' htmlFor="name">Your message</label>
                    <textarea className='input w-full h-36 bg-[#0e1e2c]'placeholder='Your message' onChange={(e)=>setMsg(e.target.value)} rows="5" />
                </div>
