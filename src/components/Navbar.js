...
function Navbar() {
  ...
  return (
    ...
    //         <h3 className="px-2 font-extrabold md:text-4xl font-serif flex">
    //           In
    ...
    //        <button className="bg-yellow-400 py-2 px-5 font-medium text-slate-900 rounded-lg hover:bg-yellow-500">Signup</button>
    //       </Link>
    //       </>
    //       )}
        
    //       <div className="hidden relative mr-3 md:mr-0 md:block"></div>
    //       <button
    ...
    //         aria-expanded="false"
    //       >
    //         <span className="sr-only" data-collapse-toggle="elementId">
    //           Open main menu
    //         </span>
    //         <svg
    //           className="w-6 h-6"
  ...
  <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
     <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
       ...
       <li>
         <Link
           to="/about"            className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
         >
           About
         </Link>
       </li>        <li>
